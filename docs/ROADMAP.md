...
- ✅ **M0** — App skeleton (React Router 7 + Vite); WorkOS AuthKit auth & tenancy on WorkOS
  Organizations; GitHub App connect; eve-repo parser; read-only visualization of an agent's full
  config surface.
